...
bool HalfEdgeMesh::AddFace(const std::vector<Vector3<float> > &verts) {
    ...
    //  size_t &indx2) {
    // v1 != e(indx1).vert)
    size_t e11, e12, e21, e22, e31, e32;

    AddHalfEdgePair(v1, v2, e11, e12);
    AddHalfEdgePair(v2, v3, e21, e22);
    AddHalfEdgePair(v3, v1, e31, e32);
...
void HalfEdgeMesh::getFaceVertices(size_t faceInd, size_t &v1, size_t &v2, size_t &v3) const {
    v1 = e((f(faceInd)).edge).vert;
    v2 = e(e((f(faceInd)).edge).next).vert;
    v3 = e(e(e((f(faceInd)).edge).next).next).vert;
}
